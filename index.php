...
-->
 <?php
session_start();
if(!isset($_SESSION['jass'])){ //session check
    echo "<Script>window.location.assign('loginuser.php?msg=Please login!!')</script>";
}
$email=$_SESSION['jass']; //session store

?> 
<h1>WELCOME User <?php echo $_SESSION['jass']?></h1>
<!DOCTYPE html>
<html lang="zxx">

<head>
    <title>Fashion Hub Ecommerce Category Bootstrap Responsive Website Template| Home :: w3layouts<?php echo $_SESSION['admin']?></title>
...
<body>
  ...
  <img src="images/pf3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Mens Shirt</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">price on flipcart</li>
    <li class="list-group-item">price on amazon</li>
    <li class="list-group-item"> price on meesho</li>
  </ul>
  <div class="card-body">
